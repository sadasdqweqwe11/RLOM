...
<script
	src="<%=path%>/js/jquery/jQuery-File-Upload/js/vendor/jquery.ui.widget.js"
	type="text/javascript"></script>
<script
	src="<%=path%>/js/jquery/jQuery-File-Upload/js/jquery.iframe-transport.js"
	type="text/javascript"></script>
<script
	src="<%=path%>/js/jquery/jQuery-File-Upload/js/jquery.fileupload.js"
	type="text/javascript"></script>
...
chart.write('chartdiv12');
            ...
            success: function(xml){  
                var apiToken =   $(xml).find("CreatedExpress").children("Epcode").text();
                $("#abc").append(apiToken+"<br/>");
            }  
        });  
...
<body>
	<div style="">
		<form id="form1" name="form1" method="post"
			...
			<table>
				<tr>
					<td><a href="<%=path%>/main.action" style="color:#0000CC;">返回主页</a>||<a
						href="<%=path%>/listUploadFiles" style="color:#0000CC;">我的订单</a><br />
						<br /></td>
				</tr>
				<tr>
					<td><span class="reply-tr">支持后缀名为xls的excel97~2003文件。</span><br />
						<br /> <input type="file" name="uploadFile"> <input
						type="submit" value="预览" />
					</td>
				</tr>
			</table>
		</form>
		...
		<form id="form2" name="form2" method="post"
			...
			action="<%=path%>/uploadTrackingno.action">
			<table>
				<tr>
					<td><span class="reply-tr">上传TrackingNo。</span><br /> <br />
						<input type="file" name="uploadTrackingno"> <input
						type="submit" value="预览" />
					</td>
				</tr>
			</table>
		...
		<form id="form4" name="form4" method="post"
			enctype="multipart/form-data"
			action="<%=path%>/uploadAmazonAmount.action">
			<table>
				<tr>
					<td><span class="reply-tr">上传Amazon amount。</span><br /> <br />
						<input type="file" name="uploadAmount"> <input
						type="submit" value="预览" />
					</td>
				</tr>
			</table>
		...
		<form id="form3" name="form3" method="post"
			...
			<input type="date" /> 请选择日期: <input type="text" value="" id="date">
			...
			<input id="vendor" name="vendor" type="text"
				style="visibility: hidden;" value="ALL"> <a
				href="javascript:void(0)" class="download">下载总分拣单</a> <a
				href="javascript:void(0)" class="downloadVendor">下载供应商标签</a>
		</form>
		<p class="color">
			...
			<a href="javascript:void(0)" class="yanwen">燕文对接</a> <a
				href="javascript:void(0)" class="getTrackingno">trac</a>
		</p>
