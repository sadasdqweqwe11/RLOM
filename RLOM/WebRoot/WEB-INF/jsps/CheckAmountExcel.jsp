	...
	<form id="form" method="post">
		...
		<c:if test="${flag == true}">
			<input type="submit" value="确认上传"
				onclick="document.getElementById('form').action='<%=path%>/storeAmountExcel';document.getElementById('form').submit();" />
		</c:if>
		<table width="1000" border="1" align="center"
			...
			<tr class="true">
				...
				<td  class="true" valign="middle"><span
					class="STYLE7">AMOUNT</span>
				</td>
				<td  class="true" valign="middle"><span
					class="STYLE7">RLORDER</span>
				</td>
			</tr>
